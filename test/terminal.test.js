...
describe("Terminal Module - execLocal", () => {
  ...
  it("executes help command and lists available commands", () => {
    ...
    const out = lines(t);
    assert.ok(
      out.some((l) => l.includes("help")),
      "should list help command",
    );
    assert.ok(
      out.some((l) => l.includes("clear")),
      "should list clear command",
    );
    assert.ok(
      out.some((l) => l.includes("echo")),
      "should list echo command",
    );
    assert.ok(
      out.some((l) => l.includes("date")),
      "should list date command",
    );
    assert.ok(
      out.some((l) => l.includes("connect")),
      "should list connect command",
    );
  });
